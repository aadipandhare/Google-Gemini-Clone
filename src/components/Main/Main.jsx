        ...
        <div className="main">
            ...
            :<div className="result">
                ...
                <div className="main-bottom">
                    ...
                    <p className="bottom-info">Gemini may display inaccurate info,including about pepole,so double-check its response.Your privacy and Gemini Apps</p>
                </div>
